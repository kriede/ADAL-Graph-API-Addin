...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype.login = function (loginStartPage) {
        ...
        this.verbose('this._idTokenNonce: ' + this._idTokenNonce);
        var urlNavigate = this._getNavigateUrl('id_token', null) + '&nonce=' + encodeURIComponent(this._idTokenNonce);
        this.verbose('urlNavigate: ' + urlNavigate);
    ...
    */
    ...
    AuthenticationContext.prototype._getNavigateUrl = function (responseType, resource) {
        ...
        var urlNavigate = this.instance + tenant + '/oauth2/v2.0/authorize' + this._serialize(responseType, this.config, this.config.scope) + this._addLibMetadata();
    ...
    AuthenticationContext.prototype._serialize = function (responseType, obj, scope) {
        ...
        if (obj !== null) {
            ...
            str.push('scope=' + encodeURIComponent(this._parseScope(scope)));
